$(document).ready(function () {
  ...
  $(".dash-contents .trade .trade-action .actions1 .buy").on(
    "click",
    function (event) {

      hideAllSections();
      $(".credit-modal-box").show();
    
        }
  );


  $(".dash-contents .trade .trade-action .actions1 .sell").on(
    "click",
    function (event) {
...
$(".real-account-box").on("click", function(event){
  event.stopPropagation();
});
...
$(".forex-box").on("click", function(event){
  event.stopPropagation();
});
...
$(".sell-option").on("click", function(event){
  ...
  $(".dash-contents .trade .trade-action .trade-amount .trade-amount-minus").on(
	...
	// Open withdraw modal
	$(".real-account-box .second .btn a.withdraw").on("click", function(){
		hideAllSections();
		$(".withdraw-modal-box").show();
	});

	// Close withdraw modal
	$(".withdraw-modal-box span.close").on("click", function(){
		$(".withdraw-modal-box").hide();
	});
	...
	// Tabs
	$(".profile-box .tabs-details").eq(0).show();

	$(".profile-box .tabs a").on("click", function(){
    ...
    $(".dash-contents .order .all-tables").css({
			"height": "100vh",
      
		});
    $(".dash-contents  .all-tables").css({
			"height": "100vh",
  ...
  // Switch tabs
	...
	// News Tab Section
	$(".dash-contents .news-section .tabs-details [news-tab-detail]").eq(0).show();
	$(".dash-contents .news-section .tabs .tab").on("click", function(){
		...
		$(".dash-contents .news-section .tabs-details [news-tab-detail]").eq(index).show();
	...
	$(".order-book-section span.close").on("click", function(){
		$('[dash-action="order-book"]').removeClass("active");
	...
	$(".calc-section span.close").on("click", function(){
		$('[dash-action="calc"]').removeClass("active");
	...
	$(".news-section span.close").on("click", function(){
		$('[dash-action="news"]').removeClass("active");
	...
	$(".credit-modal .input .selector").on("click", function(){
		var index = $(".credit-modal .input .selector").index(this);
		$(".credit-modal .input").removeClass("active");
		$(".credit-modal .input").eq(index).addClass("active");
		var digit = $(".credit-modal .input .selector span").eq(index).text();
		$("#depositAmount").val(digit);
	});

	$("#depositAmount").on("input", function(){
		var digit = $("#depositAmount").val();
		if($(".credit-modal .input .selector").text() != digit){
			$(".credit-modal .input").removeClass("active");
		}
	});

	// Change payment method
	$(".credit-modal .sidebar .links a").on("click", function(){
		var index = $(".credit-modal .sidebar .links a").index(this);
		$(".credit-modal .sidebar .links a").removeClass("active");
		$(".credit-modal .sidebar .links a").eq(index).addClass("active");
	});

	// Open credit modal
	$(".real-account-box .second .btn a.credit").on("click", function(){
		hideAllSections();
		$(".credit-modal-box").show();
	});

	// Close credit modal
	$(".credit-modal-box span.close").on("click", function(){
		$(".credit-modal-box").hide();
	});

	// Open user details
	$('[dash-action="show-users-details"]').on("click", function(e){
		e.preventDefault();
		$(".manager-tab-dtls").hide();
		$(".manager-tab-dtls").eq(5).show();
		$('[manager-tab-dtls="users"] .first-sec').hide();
		$('[manager-tab-dtls="users"] .second-sec').show();

	});

	$('[manager-tab-dtls="users"] .second-sec [dash-user-dtls-tab]').on("click", function(){
		var index = $('[manager-tab-dtls="users"] .second-sec [dash-user-dtls-tab]').index(this);
		$('[dash-user-dtls-tab-dtls]').hide();
		$('[dash-user-dtls-tab-dtls]').eq(index).show();

		$('[manager-tab-dtls="users"] .second-sec [dash-user-dtls-tab]').removeClass("live");
		$('[manager-tab-dtls="users"] .second-sec [dash-user-dtls-tab]').eq(index).addClass("live");
	});

	// Toggle withdraw part
	$(".shadowed .shadowed-btn").on("click", function(){
		var index = $(".shadowed .shadowed-btn").index(this);

		$(".shadowed .all-dtls").eq(index).toggle(200);

	});

  //ver

  $('#verify-me').on("click", function(event){
		event.preventDefault();
		$(".verification-modal-box").show();
	});

	$(".verification-modal span.close").on("click", function(){
		$(".verification-modal-box").hide();
	});

	$('[dash-action="first"]').on("click", function(){
		$(".verification-modal .container").hide();
		$(".verification-modal #container2").show();
	});

	$(".verification-modal .container .option").on("click", function(){
		$(".verification-modal .container").hide();
		$(".verification-modal #container3").show();
	});

	$('[dash-action="second"]').on("click", function(){
		$(".verification-modal .container").hide();
		$(".verification-modal #container4").show();
	});

	$('[dash-action="third"]').on("click", function(){
		$(".verification-modal .container").hide();
		$(".verification-modal #container5").show();
	});

	$('[dash-action="finish"]').on("click", function(){
		$(".verification-modal .container").hide();
		$(".verification-modal #container1").show();
		$(".verification-modal-box").hide();
	});
